...
from donkeybot.helpers.config_helper import GUILD_ID, STATUSES_LIST
...
class ActivityCog(
    Cog, name="GameActivities", description="Manages DonkeyBot's statuses"
):
    ...
    main_cmd_group = app_commands.Group(
        name="bot", description="Commands related to DonkeyBot's functionality."
    )
    ...
    @main_cmd_group.command(
        name="reload", description="Reload all modules loaded into DonkeyBot!"
    )
    async def reload(self, interaction: Interaction) -> None:
        """Reload all modules loaded into DonkeyBot!"""
    ...
    @main_cmd_group.command(
        name="status",
        description="Adds, removes, or force changes statuses for donkeybot.",
    )
    @app_commands.describe(
        action="Add, remove, or force change statuses.",
        status='What is the name of the "game" you want DonkeyBot to potentially play?',
    ...
    """ @main_cmd_group.command(
        name="pfp",
        description="Adds or force change profile pictures for donkeybot.",
    )
    @app_commands.describe(
        action="Add or force profile pictures.",
        image_url="Required for add. Full URL to the picture you want to add to donkeybot.",
    ...
    async def pfp(
        ...
        ""Adds or force change profile pictures for donkeybot.""
        await interaction.response.defer(thinking=True, ephemeral=True)
